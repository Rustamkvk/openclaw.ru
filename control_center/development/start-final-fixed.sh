...
# Финальный исправленный скрипт запуска Контрольного центра Атласа

echo "🚀 Запуск Контрольного центра Атласа (финальная версия)"
echo "========================================================"
echo ""
...
REQUIRED_FILES=("simple-http-server-fixed.js" "simple-auth-no-deps.js" "websocket-server.js" "index.html")
...
node simple-http-server-fixed.js > http-server.log 2>&1 &
HTTP_PID=$!
sleep 3
...
echo "   pkill -f \"simple-http-server-fixed.js\""
...
echo ""
echo "🔗 Ссылка для открытия в браузере:"
echo "   http://localhost:8082"
echo ""
echo "📱 Откройте эту ссылку в браузере для доступа к Контрольному центру"